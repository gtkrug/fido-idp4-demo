...
<html>
  <head>
    ...
    <script src="/js/webauthn/lib/text-encoding-0.7.0/encoding.js"></script>
    <script src="/js/webauthn/lib/text-encoding-0.7.0/encoding-indexes.js"></script>
    <script src="/js/webauthn/lib/fetch/fetch-3.0.0.js"></script>
    <script src="/js/webauthn/lib/base64js/base64js-1.3.0.min.js"></script>
    <script src="/js/webauthn/js/base64url.js"></script>
    <script src="/js/webauthn/js/webauthn.js"></script>
    ...
    <script type="application/javascript">
	  ...
	  let url = "/" + pathArray[1] + "/webauthn/registration?type=start";
          return fetch(url, {
        ...
        function submitResponse(requestId, response) {
          ...
          let mypath = window.location.pathname;
	  const pathArray = mypath.split("/");
	  let url = "/" + pathArray[1] + "/webauthn/registration?type=finish";
  ...
  <body>
    <div id="main">
      <div id="left">
	      <header>
		<img src="/my-idp/images/tx-logo.png" alt="Replace or remove this logo">
	      </header>
        <form>
          <div class="content-section">
            ...
            <div class="form-set">
              <label for="credentialNickname">Give your device a nickname (any value is fine):</label>
